...
metadata<-rbind(c("DBSCHEMA","DO_DB"),
		...
		c("DOSOURCEDATE","dodate"),
		c("DOVERSION","doversion"));
...
#add map_metadata
my $map_metadata=<<MAP;
map_metadata<-rbind(c("TERM","Disease Ontology","http://do-wiki.nubic.northwestern.edu/index.php/Download_DO","dodate"),
		    c("OBSOLETE","Disease Ontology","http://do-wiki.nubic.northwestern.edu/index.php/Download_DO","dodate"),
		    c("CHILDREN","Disease Ontology","http://do-wiki.nubic.northwestern.edu/index.php/Download_DO","dodate"),
		    c("PARENTS","Disease Ontology","http://do-wiki.nubic.northwestern.edu/index.php/Download_DO","dodate"),
		    c("ANCESTOR","Disease Ontology","http://do-wiki.nubic.northwestern.edu/index.php/Download_DO","dodate"),
		    c("OFFSPRING","Disease Ontology","http://do-wiki.nubic.northwestern.edu/index.php/Download_DO","dodate")	
);
